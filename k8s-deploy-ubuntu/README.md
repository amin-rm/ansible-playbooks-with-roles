...
This playbook is not for fully setting up a Kubernetes Cluster. It only helps you automate the standard Kubernetes bootstrapping pre-reqs.
After bootstrapping, you will need to set the cluster using "kubeadm init [+ extra args]. Read the kubeadm docs for more info..
